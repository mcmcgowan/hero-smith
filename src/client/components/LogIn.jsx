...
export const LogIn = () => {
    ...
    const handleSkipToCreator = useCallback(() => { //TODO: need to figure out how I'm going to navigate client side
        //navigate('/create', {replace: true}), [navigate]
        console.log("might use with react router")
    });
